 ...
 *  - GEB: value 13, represents Genetic Engineering and Biotechnology
 *  - PHARM: value 14, represents Pharmacy
 *  - CE: value 15, represents Civil Engineering
 ...
 *  - INFORMATION_STUDIES: value 23, represents Information Studies
 ...
 *  - char* Initial: a pointer representing the initial of the faculty member to search for
 ...
 * Return Type: a character pointer to the stored string, or NULL on allocation failure
 */
